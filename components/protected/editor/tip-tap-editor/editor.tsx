...
export default function Editor({
  className = "relative w-full focus:ring-orange-600 focus:outline-8 max-w-screen-lg border-stone-200 bg-background sm:mb-[calc(20vh)] sm:rounded-lg sm:border sm:shadow-lg",
